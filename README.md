...
## 1. Description
This repository contains the scripts and files needed to reproduce the analyses in: Martínez-Redondo, Eleftheriadi et al. (2026). *Convergent genomic trajectories shape adaptation to life on land across animal lineages*.
